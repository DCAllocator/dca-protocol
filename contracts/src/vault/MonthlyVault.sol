...
/// @title MonthlyVault
/// @notice 30-day epochs (not calendar months), 25 bps default purchase fee. Origin aligned to 00:00 UTC of deploy day.
contract MonthlyVault is PlanVault {
    uint32 public constant EPOCH_LENGTH = 30 days;
    uint16 public constant DEFAULT_PURCHASE_FEE_BPS = 25;
